...
saveButton.addEventListener("click", function () {
  const director = new Person( generateRandomInteger(1, 1000000), directorNameEl.value );
  const actors = new Person(generateRandomInteger(1, 1000000), actorNameEl.value );
